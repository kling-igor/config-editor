...
class Config {
  ...
  getAll(keyPath, options) {
    ...
    if (scope != null) {
      ...
      if (legacyScopeDescriptor) {
        result.push(
          ...Array.from(this.scopedSettingsStore.getAll(legacyScopeDescriptor.getScopeChain(), keyPath, options) || [])
        )
      }
    } else {
      result = []
  ...
  */
  ...
  resetScopedSettings(newScopedSettings, options = {}) {
    ...
    for (let scopeSelector in newScopedSettings) {
      ...
      if (validatedSettings[scopeSelector] != null) {
        this.scopedSettingsStore.addProperties(source, validatedSettings, { priority })
      }
    }
  ...
  getRawScopedValue(scopeDescriptor, keyPath, options) {
    ...
    const result = this.scopedSettingsStore.getPropertyValue(scopeDescriptor.getScopeChain(), keyPath, options)
    ...
    if (result != null) {
      ...
      return this.scopedSettingsStore.getPropertyValue(legacyScopeDescriptor.getScopeChain(), keyPath, options)
    }
  }
