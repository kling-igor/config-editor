...
const ListItem = withTheme(props => {
  ...
  const { value, onEditClick = () => {}, onDeleteClick = () => {}, theme } = props
...
export default class ArrayComponent extends Component {
  ...
  onOk = () => {
    ...
    const newArray = [...array.slice(0, editingIndex), editingValue, ...array.slice(editingIndex + 1, array.length)]
  ...
  renderItem = (value, index) => {
    ...
    return <ListItem key={value} value={value} onEditClick={editItem} onDeleteClick={deleteItem} />
  }
